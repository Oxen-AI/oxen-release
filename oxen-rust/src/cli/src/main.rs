...
async fn main() {
    ...
    let command = Command::new("oxen")
        ...
        .subcommand(cmd_setup::append())
        .subcommand(cmd_setup::delete())
    ...
    match matches.subcommand() {
        ...
        Some((cmd_setup::APPEND, sub_matches)) => parse_and_run::append(sub_matches).await,
        Some((cmd_setup::DELETE, sub_matches)) => parse_and_run::delete(sub_matches).await,
