...
use crate::core::v1::index::commit_entry_reader::CommitEntryReader;
use crate::core::v1::index::schema_reader::SchemaReader;
use crate::core::v1::index::stager::Stager;
...
pub fn add(workspace: &Workspace, filepath: &Path) -> Result<PathBuf, OxenError> {
    ...
    log::debug!("core::v1::index::workspaces::files::add adding file {filepath:?}");
