...
def test_remote_df_add_row_success(celeba_remote_repo_one_image_pushed: RemoteRepo, shared_datadir
):
...
def test_remote_df_add_row_invalid_schema(celeba_remote_repo_one_image_pushed: RemoteRepo, shared_datadir):
    _, remote_repo = celeba_remote_repo_one_image_pushed
