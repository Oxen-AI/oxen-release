...
def test_remote_add_single_file(celeba_remote_repo_one_image_pushed: RemoteRepo, shared_datadir):
...
def test_remote_add_root_dir(celeba_remote_repo_one_image_pushed: RemoteRepo, shared_datadir):
